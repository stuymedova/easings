...
export function elasticInOut(t:number) {
  return t < 0.5
    ? 0.5 * 
        Math.sin(+13.0 * Math.PI * 0.5 * 2.0 * t) *
        Math.pow(2.0, 10.0 * (2.0 * t - 1.0))
    : 0.5 * 
        Math.sin(-13.0 * Math.PI * 0.5 * ((2.0 * t - 1.0) + 1.0)) * 
        Math.pow(2.0, -10.0 * (2.0 * t - 1.0)) + 1.0;
}

export function elasticIn(t:number) {
  return Math.sin(13.0 * t * Math.PI * 0.5) * Math.pow(2.0, 10.0 * (t - 1.0));
}

export function elasticOut(t:number) {
  return Math.sin(-13.0 * (t + 1.0) * Math.PI * 0.5) * Math.pow(2.0, -10.0 * t) + 1.0;
}
